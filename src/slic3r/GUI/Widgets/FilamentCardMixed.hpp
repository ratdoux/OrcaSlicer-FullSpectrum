...
public:
    ...
    static void paint_clr_swatch_gradient(
        wxDC& context, const wxSize& size, const std::vector<wxColor>& colors, const wxString& text, bool is_dark, int padding = 0);

    static void paint_box_mix(wxDC&                            context,
                              const wxSize&                    size,
    ...
    static void paint_box_pattern(wxDC&                            context,
                                  const wxSize&                    size,
                                  const wxColor&                   background_color,
                                  const std::vector<unsigned int>& indices,
                                  const std::vector<wxColor>&      colors,
    ...
    static void paint_box_gradient(wxDC&                            context,
                                   const wxSize&                    size,
                                   const wxColor&                   background_color,
                                   const std::vector<wxColor>&      colors,
