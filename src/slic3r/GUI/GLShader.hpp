...
public:
    ...
    void set_uniform_vec4_array(const char* name, const float* value, size_t count) const;
    ...
    void set_uniform_vec4_array(int id, const float* value, size_t count) const;
