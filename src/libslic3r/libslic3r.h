...
// Combined upper limit for physical + mixed filament IDs. Facet state 0 is
// reserved, leaving IDs 1..255 available from the 256-state annotation space.
static constexpr size_t MAXIMUM_FILAMENT_NUMBER = 255;
